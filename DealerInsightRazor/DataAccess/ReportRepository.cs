...
namespace DealerInsightRazor.DataAccess
{
    /// <summary>
    ...
    public class ReportRepository
    {
        ...
        public async Task<IList<Report>> GetAvailableReportsAsync()
        {
            ...
            var (tokenCredentials, accessToken) = await _authenticationHandler.GetAzureTokenDataAsync();

            using (var client = new PowerBIClient(new Uri(_powerBiSettings.MainAddress), tokenCredentials))
            {
        ...
        public async Task<ReportEmbedConfig> GetReportForIdAsync(Guid reportId)
        {
            ...
            using (var powerBiClient = new PowerBIClient(new Uri(_powerBiSettings.MainAddress), tokenCredentials))
            {
